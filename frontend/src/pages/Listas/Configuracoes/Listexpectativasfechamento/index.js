...
export default function ListaExpectativasfechamento() {
    ...
    useEffect(() => {
        api.get('expectativas-fechamento').then(response => {            
                    ...
                    <Card>
                        ...
                        <CardBody>
                            <Table responsive striped>
                                ...
                                <tbody>
                                    {expectativasfechamento.map(expectativafechamento => (
                                        <tr>
                                            <td>{expectativafechamento.expectativafechamento}</td>                                                                                                              
                                            <td style={{ textAlign : 'right'}}>
                                                <Link to={`expectativas-fechamento/${expectativafechamento.id}`} className="btn-sm btn-primary">
