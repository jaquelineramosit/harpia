...
export default function RelContatoTempOportunidade() {
    ...
    return (
        <div className="animated-fadeIn">
               <div class="col-sm-6">
                    <h2 class="m-0 text-dark">Contato x Temperatura de Oportunidades </h2>
                </div>
                            ...
                            <Table celled >
                                <Table.Header>
                                    <Table.Row>
                                        ...
                                        <Table.HeaderCell>Temperatura de Oportunidade</Table.HeaderCell>                            
                                ...
                                <Table.Body>
                                    <Table.Row>
                                        ...
                                        <Table.Cell>Temperatura de Oportunidade</Table.Cell>
