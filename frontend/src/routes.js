...
const routes = [
  ...
  { path: '/temperatura-fechamento', exact: true, name: 'Temperatura de Fechamento', component: TemperaturaFechamento },
  { path: '/temperatura-fechamento/:id', name: 'Temperatura de Fechamento', component: TemperaturaFechamento },
  ...
  { path: '/paises', exact: true, name: 'Países', component: Paises },
  { path: '/paises/:id', name: 'Países', component: Paises },
  { path: '/pipes', exact: true, name: 'Pipes', component: Pipes },
